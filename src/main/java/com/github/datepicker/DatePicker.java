...
//        gc.set(Calendar.MINUTE, 0);
    ...
    public void setselecteddateMonth(int month)
    {
    ...
    public void setselecteddateYear(int year)
    {
        if (selectedDate == null)
        {
            return;
    ...
    public void setselecteddateDay(int day)
    {
        if (selectedDate == null)
        {
            return;
    ...
    public void setselecteddateMin(int min)
    {
        if (selectedDate == null)
        {
            return;
    ...
    public void setselecteddateHour(int hour)
    {
        if (selectedDate == null)
        {
            return;
